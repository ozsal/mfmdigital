                                                      ...
                                                      <div class="nf-field">
                                                         <div id="nf-field-9-wrap" class="field-wrap phone-wrap textbox-wrap" data-field-id="9">
                                                            <div class="nf-field-label">
                                                               ...
                                                               Password <span class="ninja-forms-req-symbol">*</span> 
                                                               </label>
                                                            </div>
                                                            <div class="nf-field-element">
                                                               <input type="password" value="" class="ninja-forms-field nf-element" id="nf-field-9" name="password" autocomplete="password" placeholder="Enter the password. " aria-invalid="false" aria-describedby="nf-error-9" aria-labelledby="nf-label-field-9" aria-required="true" required="">
                                                            </div>
                                                         </div>
                                                      </div>
                                                      <div class="nf-after-field">
                                                      ...
                                                      <div class="nf-field">
                                                         <div id="nf-field-11-wrap" class="field-wrap submit-wrap textbox-wrap" data-field-id="11">
                                                            ...
                                                            <div class="nf-field-element">
                                                               ...
                                                               &nbsp;&nbsp;&nbsp;&nbsp;<b><span>Don't have an account? </span>&nbsp;&nbsp;<a href="{{ route('front-register')}}">Sign Up</a>
                                                            </div>
